...
{
    public class SurveyInfoes2Controller : Controller
    {
        private readonly BadcDbContext _context;

        public SurveyInfoes2Controller(BadcDbContext context)
        {
            _context = context;
        }
        ...
        // POST: SurveyInfoes2/Create
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("SurveyId,EquipmentId,DistCode,UpazCode,UnionCode,MauzaName,JlNo,PlotNo,SurveyDate,NameOfScheme,OwnerOrManagerName,OwnerOrManagerMobileNo,AgencyCode,DieselEngineMakeAndModel,DieselEngineHp,ElectricMotorMakeAndModel,ElectricMotorKw,EmPowerSourceCode,PumpCapacityInCusec,SwSourceCode,SmartCard,IsPit,IsServiceable,TotalOperatingHour,BoroArea,WheatArea,PotatoArea,MaizeArea,VegWinterArea,MustardArea,OthersArea,BoroCost,WheatCost,PotatoCost,MaizeCost,VegWinterCost,OthersCost,CanalLengthPacca,CanalLengthBuriedPipe,CanalLengthFitaPipe,CanalLengthKacha,BenefitedFarmerMale,BenefitedFarmerFemale,BenefitedAgricultureLabourMale,BenefitedAgricultureLabourFemale,UseInKharif1Season,UseInKharif2Season,TotalOperatingHourKh1,AusAreaKh1,JuteAreaKh1,VegAreaKh1,OthersAreaKh1,AusCostKh1,JuteCostKh1,VegCostKh1,OthersCostKh1,BenefitedFarmerMaleKh1,BenefitedFarmerFemaleKh1,BenefitedAgricultureLabourMaleKh1,BenefitedAgricultureLabourFemaleKh1,TotalOperatingHourKh2,TAmanAreaKh2,OthersAreaKh2,TAmanCostKh2,OthersCostKh2,BenefitedFarmerMaleKh2,BenefitedFarmerFemaleKh2,BenefitedAgricultureLabourMaleKh2,BenefitedAgricultureLabourFemaleKh2,EntryDateTime,EntryUserId")] SurveyInfo surveyInfo)
        {
