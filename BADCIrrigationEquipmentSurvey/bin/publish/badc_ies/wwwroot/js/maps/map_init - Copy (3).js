...
function map_init(adminCode) {
    ...
    map.data.setStyle(function (feature) {
        ...
        //var polyOptions = $.extend(true,
        //    {},
        //    polyDefaultOptions);

        //if (feature.getProperty("isSelected")) {}

            //if (selectedAdminCode && selectedAdminCode == currAdminCode) {
            //    polyOptions = $.extend(true,{},polySelectedOptions);
            //} else {
                
            //}
        //var polyOptions = $.extend(true, {}, (selectedAdminCode && selectedAdminCode == currAdminCode) ? polySelectedOptions : polyDefaultOptions);
    ...
    map.data.addListener("click",
        function (evt) {
            ...
            selectedAdminCode = evt.feature.getProperty(adminFieldCode);
            currValue = map_data.filter(data => data.geo_code == selectedAdminCode).map(data => data.data_value);
    ...
    map.data.addListener("mouseover",
        function (evt) {
            if (selectedAdminCode && selectedAdminCode == evt.feature.getProperty(adminFieldCode))
                return;
