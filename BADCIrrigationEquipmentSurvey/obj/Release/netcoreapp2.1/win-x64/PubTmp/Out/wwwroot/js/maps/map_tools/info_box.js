...
function InfoBox(opt_opts) {
    ...
    this.paneId_ = opt_opts.paneId || null;
    this.paneClass_ = opt_opts.paneClass || null;
    this.paneZIndex_ = opt_opts.paneZIndex || (opt_opts.zIndex || null);
...
InfoBox.prototype.createInfoBoxDiv_ = function () {
    ...
    if (!this.div_) {
        ...
        var panes = this.getPanes()[this.pane_];
        //panes.sty

        if (this.paneId_)
            panes.id = this.paneId_;
        if (this.paneClass_)
            panes.class = this.paneClass_;
        if (this.paneZIndex_)
            panes.style.zIndex = this.paneZIndex_;
